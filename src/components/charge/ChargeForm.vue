<template>
    <v-card rounded="xl" style="min-width: fit-content;" class="pa-6">
        <div class="mb-2">
            ...
            <v-text-field variant="underlined" persistent-hint
                hint="Ingresá el nombre del producto o sevicio"></v-text-field>
        </div>
        <div>
        ...
        <div class="button-container">
            <v-btn class="d-flex mx-auto" prepend-icon="mdi-content-copy" width="40%" height=50
                style="min-width: fit-content;" text="Copiar enlace" variant="outlined" rounded="xl"></v-btn>
            <v-btn class="d-flex mx-auto" style="min-width: fit-content;" width="40%" height=50 color="primary"
                rounded="xl" prepend-icon="mdi-send-outline" text="Enviar enlace"></v-btn>
        </div>
    </v-card>
</template>
