<template>
    <v-card color="text" width="25vw" height="fit-content" variant="tonal" elevation="12" rounded="xl"
        ...
        <v-icon icon="mdi-format-quote-open" size="50px" />
        <p class="font-italic text-center">{{ quote }}</p>
    </v-card>
</template>
